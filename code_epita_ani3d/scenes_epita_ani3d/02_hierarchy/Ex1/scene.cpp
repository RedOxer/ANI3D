...
void scene_structure::initialize()
{
    ...
    mesh_drawable extremity_left;
    mesh_drawable extremity_right;
    ...
    extremity_left.initialize_data_on_gpu(mesh_primitive_cylinder(0.035f,{0,-0.25f,-0.25f},{0,0.25f,-0.25f}));
    extremity_right.initialize_data_on_gpu(mesh_primitive_cylinder(0.035f,{0,-0.25f,0.25f},{0,0.25f,0.25f}));
    ...
    //add rotation to cylinder1_son
    hierarchy.add(cylinder1_son, "Cylinder 1 son", "Cube 1", { 0,0,0 });
    hierarchy.add(extremity_left,"Extremity Left","Cylinder 1 son");
    hierarchy.add(extremity_right,"Extremity Right","Cylinder 1 son");
...
void scene_structure::display_frame()
{
    ...
    hierarchy["Cylinder 1 son"].transform_local.rotation = rotation_transform::from_axis_angle({0,0,5}, 10 * timer.t);
    //add pendulum motion to the base cube
    hierarchy["Cube base"].transform_local.rotation = rotation_transform::from_axis_angle({1,0,0}, M_PI/2 *std::sin(timer.t*2));
